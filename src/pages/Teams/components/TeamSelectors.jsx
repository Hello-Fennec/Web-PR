...
export default function TeamSelector({ selectedTeam, setselectedTeam }) {
  const Selector = ({ index }) => (
    <button
      ...
      className={
        ...
        " w-24 h-24 sm:w-16 sm:h-16 bg-[#F2E2BB] cursor-pointer rounded-xl shadow-xl hover:-translate-y-1 duration-300 2xl:scale-150 origin-top"
      }
    >
      <ImgContainer
        style={{
  ...
  return (
    <motion.div
      ...
      sm:flex-col sm:space-y-3 2xl:space-x-20"
    >
