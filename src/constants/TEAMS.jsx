...
const TEAMS = [
  {
    ...
    ฝ่าย Front-End จะตอบข้อสงสัยให้กับน้อง ๆ ทุกคนเอง ! เพราะเราจะมีการปูพื้นฐาน HTML, CSS และ JavaScript เพื่อนำไปต่อยอดใน Framework ยอดนิยมอย่าง React รวมถึง Version Control อย่าง Git ที่จะทำให้น้อง ๆ ได้เรียนรู้การทำงานร่วมกันได้อย่างสะดวกสบายมากขึ้นเพื่อนำไปต่อยอดในการสร้าง Website
    และน้อง ๆ จะได้ลองทำ Website ขึ้นมาจริง ๆ โดยทำงานร่วมกับฝ่ายอื่น ๆ ในทีมของเรา🖥️
    `,
    image: FrontEnd,
